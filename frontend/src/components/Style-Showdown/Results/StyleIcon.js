...
function StyleIcon() {
  return (
    <>
      <h2 className="text-[#1b0e17] text-[22px] font-bold leading-tight tracking-[-0.015em] ml-5 px-4 pb-3 pt-5" data-aos="fade-left" data-aos-duration="1500">Your Style Icon</h2>
